 ...
 *   smarter_. For example:
 *
 *     original, found in modules/field/field.module: theme_field()
 *     theme override, found in template.php: smarter_field()
 *
 *   where smarter is the name of your sub-theme. For example, the
...
function smarter_preprocess_node_shop_guide_slide_show( &$variables , $hook )
{
    ...
    drupal_add_js(drupal_get_path('theme' , 'smarter') . '/js/shopping_guide/slide_show.js' , array( 'type' => 'file' , 'group' => JS_THEME ));
}
 ...
 */
/* -- Delete this line if you want to use this function
function smarter_preprocess_comment(&$variables, $hook) {
  $variables['sample_variable'] = t('Lorem ipsum.');
}
// */
 ...
 */
/* -- Delete this line if you want to use this function
function smarter_preprocess_region(&$variables, $hook) {
 ...
 */
/* -- Delete this line if you want to use this function
function smarter_preprocess_block(&$variables, $hook) {
