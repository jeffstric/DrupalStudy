  ...
  <fieldset class="singleTextEdit">
    ...
    <table>
      <tr>
        ...
        <td>
          <input class="imTextContent" name="content" type="text" title="Type the message you'd like display"  msg="content must be input" valid="free" style="width:320px"/>
        </td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td>
          <input class="imColor" name="color" type="text" title="The color of font,no '#'" msg="color must be string with six character" valid="color" />
        </td>
      </tr>
      <tr>
        <td colspan="2">
      ...
      <tr>
        <td>  <label>x</label></td>
        <td>   
          <input class="imPosX" name ="x" type="text" title="The horizontal position of text" msg="position of x must be numeric" valid="num" style="width:320px"/>
        </td>
      </tr>
      <tr>
        <td> <label>y</label></td>
        <td>
          <input class="imPosY" name="y" type="text" title="Vertical position of text,unite:<?php echo $fontSizeUnite ?>" msg="position of y must be numeric" valid="num" style="width:320px"/>
        </td>
      </tr>
      <tr>
        <td>
...
<script type="text/javascript">
  ...
  function checkValid(str,valid){
    ...
    switch(valid){
      case 'color':
        var pattern = new RegExp('^(?:[0-9a-f]{3}){1,2}$');
